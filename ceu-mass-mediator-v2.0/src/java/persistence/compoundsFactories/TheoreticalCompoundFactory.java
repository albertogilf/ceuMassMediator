...
public interface TheoreticalCompoundFactory<T> {
    ...
    public TheoreticalCompounds construct(T nc, Double mass, Double rt, Double massToSearch, 
            String adduct, boolean isAdductAutoDetected, String adductAutoDetected);
     ...
     */
    public TheoreticalCompounds construct(T nc, Double mass, Double rt, Double massToSearch, 
            String adduct, boolean isAdductAutoDetected, String adductAutoDetected, Boolean isSignificative);
