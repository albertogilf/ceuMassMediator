...
public interface Constants {
    ...
    public static final String TOLERANCE_INITIAL_VALUE = "10";
    public static final String TOLERANCE_MODE_INITIAL_VALUE = "ppm";
    public static final String RMT_TOLERANCE_INITIAL_VALUE = "10";
    public static final String RMT_TOLERANCE_MODE_INITIAL_VALUE = "percentage";
    ...
    // CEMS HEADERS
    public static final String RMT_HEADER = "RMT";
    public static final String STANDARD_RMT_HEADER = "RMT";
    public static final String RMT_ERROR_HEADER = "RMT error";
    public static final String FRAGMENTS_HEADER = "Fragments observed";
     ...
     */
    public static final String CEDEMOMASSFORTARGETED
            = "310.1138\n";
    
        /**
     * String for the sample of ce RMT for TARGETED
     */
    public static final String CEDEMORMTFORTARGETED
            = "1.70\n";
    
    /**
     * String for the sample of CE GROUPED signals (Targeted search)
     */
    public static final String CEDEMOGROUPEDSIGNALS
            = "(619.2192, 5),"
            + "(657.1751, 50),"
            + "(641.2012, 20),"
            + "(332.0952, 90),"
