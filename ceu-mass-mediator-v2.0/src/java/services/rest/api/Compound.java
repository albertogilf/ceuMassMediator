...
public class Compound {
    ...
    public Compound(int identifier, double EM, String name, String formula, String adduct,
            double molecular_weight, int error_ppm, float ionizationScore, float finalScore, String cas,
