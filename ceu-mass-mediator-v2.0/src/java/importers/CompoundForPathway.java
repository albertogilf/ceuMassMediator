...
public class CompoundForPathway implements Serializable {
    ...
    public String keggCompoundWebPage() {
        return WEB_COMPUESTO_KEGG + this.keggCompound;
    }
    ...
    public String HMDBCompoundWebPage() {
        return WEB_COMPUESTO_HMDB + this.HMDBCompound;
    }
    ...
    public String LMCompoundWebPage() {
        return WEB_COMPUESTO_LM + this.LMCompound;
    }
    ...
    public String metlinCompoundWebPage() {
        return WEB_COMPUESTO_METLIN + this.metlinCompound;
    }
    ...
    public String PCCompoundWebPage() {
        return WEB_COMPUESTO_PUBCHEMICHAL + this.PCCompound;
    }
    ...
    public void toExcel(WritableSheet sheet, int row, int flag) throws WriteException, MalformedURLException {
        ...
        if (flag == 1) {
            ...
            if (!this.keggCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.KEGG.getnColumn(), row, new URL(WEB_COMPUESTO_KEGG + this.keggCompound));
            ...
            if (!this.HMDBCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.HMDB.getnColumn(), row, new URL(WEB_COMPUESTO_HMDB + this.HMDBCompound));
            ...
            if (!this.LMCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.LIPIDMAPS.getnColumn(), row, new URL(WEB_COMPUESTO_LM + this.LMCompound));
            ...
            if (!this.metlinCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.METLIN.getnColumn(), row, new URL(WEB_COMPUESTO_METLIN + this.LMCompound));
            ...
            if (!this.PCCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.PUBCHEM.getnColumn(), row, new URL(WEB_COMPUESTO_PUBCHEMICHAL + this.PCCompound));
            ...
            if (!this.keggCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.KEGG.getnColumn() - 1, row, new URL(WEB_COMPUESTO_KEGG + this.keggCompound));
                hl.setDescription(this.keggCompound);
                sheet.addHyperlink(hl);
            } else {
            ...
            if (!this.HMDBCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.HMDB.getnColumn() - 1, row, new URL(WEB_COMPUESTO_HMDB + this.HMDBCompound));
                hl.setDescription(this.HMDBCompound);
                sheet.addHyperlink(hl);
            } else {
            ...
            if (!this.LMCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.LIPIDMAPS.getnColumn() - 1, row, new URL(WEB_COMPUESTO_LM + this.LMCompound));
                hl.setDescription(this.LMCompound);
                sheet.addHyperlink(hl);
            } else {
            ...
            if (!this.metlinCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.METLIN.getnColumn() - 1, row, new URL(WEB_COMPUESTO_METLIN + this.LMCompound));
                hl.setDescription(this.metlinCompound);
                sheet.addHyperlink(hl);
            } else {
            ...
            if (!this.PCCompound.equals("")) {
                WritableHyperlink hl = new WritableHyperlink(PathwayColumns.PUBCHEM.getnColumn() - 1, row, new URL(WEB_COMPUESTO_PUBCHEMICHAL + this.PCCompound));
                hl.setDescription(this.PCCompound);
                sheet.addHyperlink(hl);
            } else {
    ...
    public String keggToHtml() {
        String s = "";
        if (!this.keggCompound.equals("")) {
            s = "<a href='" + WEB_COMPUESTO_KEGG + this.keggCompound + "'>"
                    + this.keggCompound + "</a>";
        }
        return s;
    }
    ...
    public String hmdbToHtml() {
        String s = "";
        if (!this.HMDBCompound.equals("")) {
            s = "<a href='" + WEB_COMPUESTO_HMDB + this.HMDBCompound + "'>"
                    + this.HMDBCompound + "</a>";
        }
        return s;
    }
    ...
    public String lmToHtml() {
        String s = "";
        if (!this.LMCompound.equals("")) {
            s = "<a href='" + WEB_COMPUESTO_LM + this.LMCompound + "'>"
                    + this.LMCompound + "</a>";
        }
        return s;
    }
    ...
    public String metlinToHtml() {
        String s = "";
        if (!this.metlinCompound.equals("")) {
            s = "<a href='" + WEB_COMPUESTO_METLIN + this.metlinCompound + "'>"
    ...
    public String pcToHtml() {
        String s = "";
        if (!this.PCCompound.equals("")) {
            s = "<a href='" + WEB_COMPUESTO_PUBCHEMICHAL + this.PCCompound + "'>"
                    + this.PCCompound + "</a>";
        }
        return s;
    }
