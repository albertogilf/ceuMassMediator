 ...
 * Compound. Therefore, it contains the compound's data from the database and
 * the user's input data about the experiment (ex. rt)
 *
 * @author Maria Postigo. San Pablo-CEU
 * @version: 4.0, 24/04/2018
 */
public class CompoundLCMS extends Compound {
    ...
    public boolean isShowPathways() {
        return showPathways;
    }

    public void setShowPathways(Boolean showPathways) {
        this.showPathways = showPathways;
    }

    public void exchangeShowPathways() {
