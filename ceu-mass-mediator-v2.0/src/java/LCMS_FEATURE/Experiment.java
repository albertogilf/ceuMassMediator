...
public class Experiment {
     ...
     * Rules about ionization, about relation between features and about 
     * RT order elution of compounds are applied
     *
     */
     ...
     * It means that only ionization rules will be applied since there is no 
     * RT available, as well as CS. 
     *
     */
    ...
    /**
     *
     * @return the list of annotations without grouping. Mainly used for exporting to 
     * other format where there is no hierarchy (like excel)
     */
