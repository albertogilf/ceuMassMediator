...
import facades.OxidationFacade;
 ...
 */
@ManagedBean(name = "oxidationControllerJDBC")
@SessionScoped
public class OxidationControllerJDBC implements Serializable {
    ...
    private List<CompoundOxidized> oxidizedCompoundsList;

    private final facades.OxidationFacade oxidationFacade;
    ...
    public void loadLCOxidations() {
        ...
        OxidationLists.LIST_LONG_CHAIN_OXIDATION_TYPES.forEach((oxidation) -> {
    ...
    public void loadSCOxidations() {
        this.oxidationsCandidates.clear();
        this.oxidationsCandidates.add(new SelectItem("allOxidations", "All"));
        OxidationLists.LIST_SHORT_CHAIN_OXIDATION_TYPES.forEach((oxidation) -> {
            this.oxidationsCandidates.add(new SelectItem(oxidation, oxidation));
        });
    }
    ...
    public void submitLCOxidationCompounds() {
        ...
        List<Double> fattyAcidMassesAux = new ArrayList<>();
    ...
    private OxidationFacade getFacade() {
        return this.oxidationFacade;
    }
    ...
    public List<CompoundOxidized> getOxidizedCompoundsList() {
    ...
    */
    ...
    private void processSCOxidationCompounds() {
        ...
        /*
            ...
            System.out.println(" OXIDATIONS TO SEARCH: " + this.oxidations);
         */
        this.oxidizedCompoundsList = this.oxidationFacade.findSCOxidizedFA(this.queryParentIonMass,
                this.queryFattyAcidMasses,
                this.inputModeToleranceForFA,
                Double.parseDouble(this.inputToleranceForFA),
                this.inputModeToleranceForPI,
