...
public class AdvancedCompound extends Compound {
    ...
    public AdvancedCompound(int identifier, double EM, double RT, String name, String formula, String adduct,
            double molecular_weight, int error_ppm,
            float ionizationScore, float adductRelationScore, float RTscore, float finalScore, String cas,
            String kegg_compound, String kegg_uri, String hmdb_compound,
            String hmdb_uri, String lipidmaps_compound, String lipidmaps_uri,
            String metlin_compound, String metlin_uri, String pubchem_compound,
            String pubchem_uri, List<PathWay> pathways) {
        super(identifier,EM,name,formula,adduct,molecular_weight, error_ppm, ionizationScore, finalScore, cas, 
                ...
                metlin_compound, metlin_uri, pubchem_compound, pubchem_uri, pathways);
        this.RT = RT;
