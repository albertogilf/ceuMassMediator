 ...
 */
@XmlRootElement
public class NewCompoundsGenAdapter extends TheoreticalCompoundsAdapter implements Serializable {

    private static final long serialVersionUID = 1L;
    
    NewCompoundsGen newCompoundsGen;
     ...
     */
    public NewCompoundsGenAdapter(NewCompoundsGen ncg, 
            Double em, 
            Double rt, 
            Double massToSearch, 
            String adduct, 
        ...
        if (this.newCompoundsGen == null) {
            ...
            super.setPPMIncrement(massToSearch, (Double) this.newCompoundsGen.getMass());
        }
    ...
    public String getName() {
        if (this.newCompoundsGen == null) {
            if (this.boolAdductAutoDetected) {
                return "No In Silico compounds found for experimental mass " + this.experimentalMass + " and adduct: "
